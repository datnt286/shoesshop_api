...
using static shoesshop_api.DTOs.EmailDTO;
using System.Web;
using System.Net;
...
namespace shoesshop_api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IWebHostEnvironment environment, ShoesshopContext context, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                var encodedEmail = WebUtility.UrlEncode(user.Email); // Encode the email
                var callbackUrl = $"http://localhost:3000/reset-password?token={encodedToken}&email={encodedEmail}";
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <p>Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn. Để đặt lại mật khẩu, vui lòng nhấp vào liên kết bên dưới:</p>
            <a href='{callbackUrl}' class='btn'>Bấm vào đây</a>
            <p>Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.</p>
        </div>
        <div class='footer'>
            <p>© 2024 Công ty của bạn. Tất cả các quyền được bảo lưu.</p>
        </div>
    </div>
</body>
</html>";
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset Password", emailContent);
        ...
        public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordRequest model)
        {
            ...
            var decodedToken = model.Token; // Decode the token
