	...
	public class UsersController : ControllerBase
	{
		...
		public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordRequest request)
		{
			if (ModelState.IsValid)
			{
				...
				var callbackUrl = $"http://localhost:3000/dat-lai-mat-khau?token={encodedToken}&email={encodedEmail}";
				...
				var emailContent = $@"
                    ...
                    <body>
                        <div class='content'>
                            ...
                            <a href='{callbackUrl}' class='link'>Bấm vào đây</a>
                            <p>Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.</p>
                        </div>
                    </body>
                </html>";

				await _emailSender.SendEmailAsync(request.Email, "Đặt Lại Mật Khẩu", emailContent);
				return Ok("The password reset email has been sent.");
			}
		...
		public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordRequest request)
		{
			...
			if (result.Succeeded)
			{
				return Ok("The password has been reset successfully.");
			}
